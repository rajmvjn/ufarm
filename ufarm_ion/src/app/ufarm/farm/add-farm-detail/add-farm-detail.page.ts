...
export class AddFarmDetailPage implements OnInit {
  edit_id = "";
  imageUrl = "";
  categories: Category[];
  ...
  ngOnInit() {
    ...
    this.route.paramMap.subscribe((paramMap) => {
      if (paramMap.has("_id")) {
        ...
        this.farmService.getFarmItem(this.edit_id).subscribe((farmItem) => {
  ...
  onAddFarmItem() {
    this.farmService.addFarmItem(this.form.value).subscribe(() => {
